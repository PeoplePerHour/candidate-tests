...
<html lang="en">
	...
	<body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-sidebar-fixed page-md">
						...
						<div class="col-md-12">
							<div class="portlet light ">
								<div class="portlet-title">
									<div class="caption">
										<span class="caption-subject font-red-sunglo bold">User Info</span>
									</div>
								</div>
													...
													<div class="row">
														<div class="col-xs-6 col-sm-3 col-lg-3">
															<div class="form-group">
																...
																<select id="gender" class="form-control" name="gender">
																	<option value="0" <?= isset($_SESSION['Users']['insert_user']['gender']) && $_SESSION['Users']['insert_user']['gender'] == 0 ? 'selected' : '' ?>>Select Gender</option>
																	<option value="1" <?= isset($_SESSION['Users']['insert_user']['gender']) && $_SESSION['Users']['insert_user']['gender'] == 1 ? 'selected' : '' ?>>Male</option>
																	<option value="2" <?= isset($_SESSION['Users']['insert_user']['gender']) && $_SESSION['Users']['insert_user']['gender'] == 2 ? 'selected' : '' ?>>Female</option>
																</select>
															</div>
														</div>
														...
														<div class="col-xs-6 col-sm-3 col-lg-3">
															<div class="form-group">
																...
																<input name="location" type="text" class="form-control" value="<?= isset($_SESSION['Users']['insert_user']['location']) ? $_SESSION['Users']['insert_user']['location'] : '' ?>" />
															</div>
														</div>
													</div>
													...
													<div class="row">
														<div class="col-xs-6 col-sm-3 col-lg-2">
															<div class="form-group">
																...
																<?php
																	if(isset($_SESSION['Users']['insert_user']['birthdate']) && !empty($_SESSION['Users']['insert_user']['birthdate']))
																	{
																		$birthdate = \DateTime::createFromFormat('Y-m-d', $_SESSION['Users']['insert_user']['birthdate']);
													...
													<div class="row">
														<div class="col-xs-6 col-sm-3 col-lg-2">
															<div class="form-group">
																...
																<textarea id="description" name="description" class="form-control" rows="5" cols="20"><?= isset($_SESSION['Users']['insert_user']['description']) ? $_SESSION['Users']['insert_user']['description'] : '' ?></textarea>
															</div>
														</div>
													</div>
												</div>
		...
		<div class="page-footer">
            ...
            <script src="<?= DOMAIN ?>/theme/admin/assets/global/plugins/icheck/icheck.min.js" type="text/javascript"></script>
