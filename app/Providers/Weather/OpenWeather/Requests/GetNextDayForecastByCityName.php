...
class GetNextDayForecastByCityName extends RequestAbstract
{
    ...
    {
        return new \App\Providers\Weather\OpenWeather\Responses\GetNextDayForecastByCityName();
    }
}