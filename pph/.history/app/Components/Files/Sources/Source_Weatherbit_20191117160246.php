...
class Source_Weatherbit extends Source
{
    ...
    {
        print substr(strrchr(__CLASS__, "\\"), 1);    
        print_r(Config::get($this->configBasePath[__CLASS__]));
        die();
        $this->forecastDaysToDo = Config::get($this->configBasePath)[__CLASS__][self::DAYS_TO_FORECAST];
    }
}
