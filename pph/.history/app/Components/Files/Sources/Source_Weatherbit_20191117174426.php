...
class Source_Weatherbit extends Source
{
    ...
    {
        $this->sourceApiCall = Config::get($this->configBasePath)[substr(strrchr(__CLASS__, "\\"), 1)][self::MAIN_URL] . "?key=" . $this->apiKey . "&city_id=" . $this->cityId . "&days=" . $this->forecastDaysToDo. "&units"=;
    }
