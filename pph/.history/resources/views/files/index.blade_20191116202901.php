                    ...
                    <div class="row">
                        ...
                        <table id = "filesTable" class="table table-dark">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td scope="row">{{$file->id}}</th>
                                    <td scope="row">{{$file->path.$file->name}}</th>
                                    <td scope="row">{{$file->created_at}}</th>
                                    <td>
                                        <select name="operation" id = "foMethod">
                                            <option value="FO_ValidFilePerLine">Valid and Insert to Table per Line
                                            </option>
                                    </th>
                                    <th scope="row"><input type="button" name="applyOperation" id = "applyOperation" value="Apply File Operation"></th>       
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
